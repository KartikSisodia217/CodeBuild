          ...
          <div className="p-6 rounded-2xl bg-[#0E131F] border border-[#1F293D] space-y-6">
            ...
            <div className="space-y-3">
              <div className={clsx(
                ...
                injectionDetected ? "bg-red-950/15 border-red-500/25 text-red-300" : "bg-[#080D17] border-[#1F293D] text-slate-400"
              )}>
                <div className="flex items-center space-x-3">
                  {injectionDetected ? <CheckCircle2 className="w-5 h-5 text-red-400" /> : <div className="w-5 h-5 rounded-full border border-slate-700" />}
                  <div>
                ...
                <span className="text-xs font-mono font-bold">{injectionDetected ? 'TRUE' : 'FALSE'}</span>
              </div>

              <div className={clsx(
                "p-3.5 rounded-xl border flex items-center justify-between",
                behaviorInfluenced ? "bg-red-950/15 border-red-500/25 text-red-300" : "bg-[#080D17] border-[#1F293D] text-slate-400"
              )}>
                <div className="flex items-center space-x-3">
                  {behaviorInfluenced ? <CheckCircle2 className="w-5 h-5 text-red-400" /> : <div className="w-5 h-5 rounded-full border border-slate-700" />}
                  <div>
                ...
                <span className="text-xs font-mono font-bold">{behaviorInfluenced ? 'TRUE' : 'FALSE'}</span>
              </div>

              <div className={clsx(
                "p-3.5 rounded-xl border flex items-center justify-between",
                sinkReached ? "bg-red-950/15 border-red-500/25 text-red-300" : "bg-[#080D17] border-[#1F293D] text-slate-400"
              )}>
                <div className="flex items-center space-x-3">
                  {sinkReached ? <CheckCircle2 className="w-5 h-5 text-red-400" /> : <div className="w-5 h-5 rounded-full border border-slate-700" />}
                  <div>
                    <div className="text-xs font-bold font-mono uppercase">3. High-Risk Sink Invocation Reached</div>
                    <div className="text-[11px] text-slate-400">Agent attempted invocation of {evaluation?.violating_tool || 'a restricted tool'}() without human confirmation</div>
                  </div>
                </div>
                <span className="text-xs font-mono font-bold">{sinkReached ? 'TRUE' : 'FALSE'}</span>
              </div>

              <div className={clsx(
                "p-3.5 rounded-xl border flex items-center justify-between",
                unauthorizedMutation ? "bg-red-950/15 border-red-500/25 text-red-300" : "bg-[#080D17] border-[#1F293D] text-slate-400"
              )}>
                <div className="flex items-center space-x-3">
                  {unauthorizedMutation ? <CheckCircle2 className="w-5 h-5 text-red-400" /> : <div className="w-5 h-5 rounded-full border border-slate-700" />}
                  <div>
                ...
                <span className="text-xs font-mono font-bold">{unauthorizedMutation ? 'TRUE' : 'FALSE'}</span>
              </div>
            </div>
            ...
            <div className={clsx(
              ...
              <div className="text-right font-mono text-xs">
                ...
                <div className="text-indigo-400 font-bold">{evaluation?.latency_ms ?? '—'}ms</div>
              </div>
            </div>
