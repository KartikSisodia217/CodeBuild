...
> [!IMPORTANT]
> **Legal.AI** is built differently. It is a multi-agent, retrieval-grounded AI legal assistant powered by **Gemma 4**, engineered from the ground up to let any citizen describe a legal problem in their own words — voice or text, English, Hindi, Hinglish, or a regional language — and receive a legally-grounded, citation-backed, and procedurally actionable answer.
