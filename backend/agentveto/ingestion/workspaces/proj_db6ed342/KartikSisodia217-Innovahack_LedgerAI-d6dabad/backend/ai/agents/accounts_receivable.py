...
class AccountsReceivableAgent(BaseAgent):
    def __init__(self):
        super().__init__(agent_name="accounts_receivable")
    ...
    async def execute(self, context: ExecutionContext) -> AgentExecutionResult:
        ...
        prompt = f"""You are the Accounts Receivable Specialist at LedgerAI, a premium AI Accounting Firm.
Do NOT introduce yourself with generic phrases.

Your specific domain is outstanding invoices, customer aging, incoming payments, collections, and receivable trends.
Do not fabricate data. Use only the provided context.

STRICT RULES:
1. SPECIALIST BOUNDARIES: Stay within Accounts Receivable. Do not perform fraud detection or ledger reconciliation.
...
6. RECOMMENDATIONS: Keep recommendations proportional. Prefer review, investigate, reconcile, validate, or monitor.
...
9. ACCOUNTING TERMINOLOGY: Use consistent terms: Accounts Receivable, Working Capital, Operating Expenses, Cash Flow.
...
"""
        ...
        result.agent_name = "Accounts Receivable Specialist"
